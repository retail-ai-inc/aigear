...
class Scheduler:
    ...
    def create(self):
        ...
        if "ERROR" in event:
            ...
            logger.info(
                f"Scheduler job '{self.name}' created successfully. (schedule: {self.schedule}, timezone: {self.time_zone})"
            )
    ...
    def update(self):
        ...
        if "ERROR" in event:
            ...
            logger.info(
                f"Scheduler job '{self.name}' updated successfully. (schedule: {self.schedule})"
            )
