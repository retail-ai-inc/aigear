...
class Project:
    ...
    def init(self):
        ...
        """
        project_logger.info(f"Initializing project: {self.name}")

        project_path = Path.cwd() / self.name
        project_path.mkdir(parents=True, exist_ok=True)
        project_logger.info(f"Created project directory: {project_path}")

        # Create directory structure
        directories = ["cloudbuild", "docs", "kms", "src", "src/pipelines"]
        for dir_name in directories:
            (project_path / dir_name).mkdir(parents=True, exist_ok=True)
        project_logger.info("Created project directory structure")
        ...
        project_logger.info("Created project template files")

        project_logger.info("Project structure:")
        ...
        project_logger.info("Copied template files")

        project_logger.info(f"Project {self.name} initialization completed")
